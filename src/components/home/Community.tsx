    ...
    <section className="bg-[#f5f5f7] px-5 py-24 sm:px-8 sm:py-32 lg:py-40">
      <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[.78fr_1.22fr] lg:gap-24">
        <div>
          ...
          <h2 className="mt-6 text-[clamp(2.2rem,4.7vw,4rem)] font-semibold leading-[0.96] tracking-[-0.055em] text-[#111]">
            You don’t have to grow alone.
          </h2>
          <p className="mt-7 max-w-lg text-base leading-7 text-[#1d1d1f]/[0.58] sm:text-lg sm:leading-8">
        ...
        <div className="rounded-[2rem] border border-black/[0.06] bg-white p-3 shadow-[0_28px_90px_rgba(0,0,0,.09)] sm:p-4">
          <div className="overflow-hidden rounded-[1.45rem] bg-[#171717] text-white">
            <div className="flex items-center justify-between border-b border-white/[0.10] px-5 py-5 sm:px-7">
              <div>
                <p className="text-sm font-semibold">Purity of Hearts</p>
                <p className="mt-1 text-[11px] text-white/[0.35]">Member community</p>
              </div>
              <div className="flex items-center gap-2 text-xs text-white/[0.40]">
            ...
            <div className="grid md:grid-cols-[180px_1fr]">
              <div className="hidden border-r border-white/[0.10] p-5 md:block">
                <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-white/[0.30]">
                  Channels
                </p>
              ...
              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-2 border-b border-white/[0.10] pb-4 text-sm font-medium">
                ...
                <div className="mt-4 space-y-3">
                  {messages.map((message) => (
                    ...
                    >
                      ...
                      <p className="mt-3 text-xs leading-6 text-white/[0.58] sm:text-sm">
                        {message.text}
                      </p>
                      <div className="mt-3 flex gap-4 text-[10px] text-white/[0.28]">
