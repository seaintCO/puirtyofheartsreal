    ...
    <main className="min-h-screen bg-[#FFF8F2] px-6 py-24">
      ...
      <section className="mx-auto mt-16 max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-[#1F1F1F]/70">
          ...
          <p>Digital products, downloadable resources, courses, community memberships, and coaching sessions are generally non-refundable once access has been granted, unless required by law or approved case by case.</p>
