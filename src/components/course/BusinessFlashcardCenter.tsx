    ...
    <section>
      ...
      <div className="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
        <aside className="liquid-card-dark rounded-[2rem] p-5">
          ...
          <p className="mt-3 text-sm leading-relaxed text-white/[0.40]">
            {module.description}
          </p>
                ...
                <button
                  ...
                  className={`flex aspect-square items-center justify-center rounded-xl text-xs font-semibold transition ${
                    active
                      ? "bg-gradient-to-r from-[#f653a6] to-[#8f75ff] text-white"
                      : complete
                        ? "bg-green-400/[0.15] text-green-300"
                        : "bg-white/[0.05] text-white/[0.40]"
                  }`}
                >
          ...
          <button
            onClick={randomCard}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-white/[0.10] px-5 py-3 text-sm text-white/[0.60] transition hover:bg-white/[0.06] hover:text-white"
          >
            <Shuffle size={16} />
            Shuffle Cards
          </button>
        ...
        <div>
          <button
            ...
            className="group flex min-h-[460px] w-full items-center justify-center rounded-[2.5rem] border border-[#ff75b8]/[0.25] bg-gradient-to-br from-[#2a1324] via-[#17101f] to-[#0b0912] p-8 text-center shadow-2xl transition hover:border-[#ff75b8]/[0.60] md:p-14"
          >
            {!flipped ? (
              <div>
                ...
                <h2 className="mx-auto mt-8 max-w-3xl text-3xl font-semibold leading-tight md:text-5xl">
                  {card.front}
                </h2>

                <p className="mt-10 text-sm text-white/[0.35]">
              ...
              <div className="max-w-4xl">
                ...
                <div className="mt-9 grid gap-4 text-left md:grid-cols-2">
                  <div className="liquid-subcard-dark rounded-2xl p-5">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-white/[0.60]">
                      {card.connection}
                    </p>
                  </div>
          ...
          <div className="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
            <button
              ...
              className="flex items-center gap-2 rounded-full border border-white/[0.10] px-6 py-3 text-sm text-white/[0.60]"
            >
              <ArrowLeft size={16} />
              Previous
            </button>
          ...
          <button
            ...
            className="mx-auto mt-5 flex items-center gap-2 text-xs text-white/[0.35] hover:text-white"
          >
            <RotateCcw size={14} />
            Show question side
          </button>
