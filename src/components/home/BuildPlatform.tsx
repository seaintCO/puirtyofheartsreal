        ...
        <div>
          ...
          <div className="mt-7 space-y-3">
            {[
              ...
              <p
                key={item}
                className="flex items-center gap-3 text-sm text-[#1d1d1f]/[0.58]"
              >
        ...
        <div className="rounded-[2rem] border border-black/[0.06] bg-white p-3 shadow-[0_28px_90px_rgba(0,0,0,.09)] sm:p-4">
          <div className="rounded-[1.45rem] bg-[#101010] p-5 text-white sm:p-7">
            <div className="flex items-center justify-between border-b border-white/[0.10] pb-5">
              ...
              <span className="rounded-full bg-emerald-400/[0.10] px-3 py-1.5 text-[10px] text-emerald-300">
                Interactive demo
              </span>
            </div>
            ...
            <div className="mt-5 grid grid-cols-3 gap-2 sm:gap-3">
              {[
                ...
                <div
                  key={label}
                  className="rounded-2xl border border-white/[0.10] bg-white/[0.04] p-3 sm:p-4"
                >
                  <Icon size={15} className="text-[#d9bb6d]" />
                  <p className="mt-5 text-lg font-semibold sm:text-xl">{value}</p>
                  <p className="mt-1 text-[9px] text-white/[0.30] sm:text-[10px]">
                    {label}
                  </p>
                </div>
              ))}
            ...
            <div className="mt-4 rounded-2xl border border-white/[0.10] bg-white/[0.04] p-4 sm:p-5">
              <p className="text-xs font-semibold">Today</p>
              <div className="mt-4 divide-y divide-white/[0.10]">
                {[
                  ...
                  >
                    ...
                    <span className="truncate text-white/[0.58]">{service}</span>
                    <span className="hidden text-white/[0.28] sm:block">{status}</span>
                  </div>
                ))}
              </div>
            </div>
