  ...
  return (
    <section className="mx-auto max-w-5xl">
      ...
      {!complete || !certificate ? (
        <div className="mt-10 liquid-card-dark rounded-[2rem] p-8 text-center sm:p-12">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white/[0.05] text-[#ff75b8]">
            <LockKeyhole size={24} />
          </div>
          <h2 className="mt-6 text-2xl font-medium">Certificate locked</h2>
          <p className="mt-3 text-sm text-white/[0.38]">
            {count ?? 0} of {businessLessons.length} lessons complete
          </p>
          <div className="mx-auto mt-6 h-1.5 max-w-md rounded-full bg-white/[0.10]">
            <div
        ...
        <div className="mt-10">
          <div className="certificate-sheet relative overflow-hidden rounded-[2rem] border border-[#ff75b8]/[0.30] bg-[#f8f1e7] p-8 text-center text-[#1f1f1f] shadow-2xl sm:p-16">
            <div className="absolute inset-4 rounded-[1.5rem] border border-[#d94898]/[0.25]" />
            <div className="relative">
              <BadgeCheck size={44} className="mx-auto text-[#d94898]" />
              <p className="mt-7 text-xs font-semibold uppercase tracking-[0.35em] text-[#c9367d]">
                Certificate of completion
              </p>
              <h2 className="mt-7 font-serif text-3xl sm:text-5xl">
                Business Management
                <br />& Leadership
              </h2>
              <p className="mt-8 text-sm text-[#1f1f1f]/[0.50]">
                This certificate is proudly presented to
              </p>
              <p className="mt-4 font-serif text-3xl italic sm:text-4xl">
                {profile.full_name || user.email}
              </p>
              <p className="mx-auto mt-7 max-w-2xl text-sm leading-6 text-[#1f1f1f]/[0.48]">
                for completing the full Purity of Hearts course curriculum and
                its guided learning activities.
              </p>
              <div className="mx-auto mt-10 flex max-w-lg flex-col justify-between gap-5 border-t border-[#1f1f1f]/[0.10] pt-6 text-xs text-[#1f1f1f]/[0.45] sm:flex-row">
                <span>
                  Issued{" "}
